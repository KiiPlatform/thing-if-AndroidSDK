...
public class GatewayAPI4EndNodeImpl extends AbstractGatewayAPI implements GatewayAPI4EndNode {

    GatewayAPI4EndNodeImpl(
            @Nullable Context context,
            @NonNull KiiApp app) {
        super(context, app);
    }
    protected GatewayAPI4EndNodeImpl(Parcel in) {
        super(in);
    }

    public static final Parcelable.Creator<GatewayAPI4EndNodeImpl> CREATOR
            = new Parcelable.Creator<GatewayAPI4EndNodeImpl>() {
        public GatewayAPI4EndNodeImpl createFromParcel(Parcel in) {
            return new GatewayAPI4EndNodeImpl(in);
        }

        public GatewayAPI4EndNodeImpl[] newArray(int size) {
            return new GatewayAPI4EndNodeImpl[size];
        }
    };
