    ...
    public void testToJSONObject() throws JSONException {
        JSONObject[] expectedJsons = {
                new JSONObject()
                        ...
                        .put("field", "f")
                        .put("lowerLimit", 23)
                        .put("lowerIncluded", false),
                new JSONObject()
                        .put("alias", "alias")
                        .put("type", "range")
                        .put("field", "f")
                        .put("upperLimit", 23)
                        .put("upperIncluded", false),
                new JSONObject()
                        .put("alias", "alias")
                        .put("type", "range")
                        .put("field", "f")
                        .put("lowerLimit", 23)
                        .put("lowerIncluded", true),
                new JSONObject()
                        .put("alias", "alias")
                        .put("type", "range")
                        .put("field", "f")
                        .put("upperLimit", 23)
                        .put("upperIncluded", true),
                new JSONObject()
                        .put("alias", "alias")
                        .put("type", "range")
                        .put("field", "f")
                ...
                new JSONObject()
                        ...
                        .put("type", "range")
                        .put("field", "f")
                        .put("lowerLimit", 23.01)
                        .put("lowerIncluded", false),
        };

        RangeClauseInTrigger[] actualObjs = {
                RangeClauseInTrigger.greaterThan("alias", "f", 23),
                RangeClauseInTrigger.lessThan("alias", "f", 23),
                RangeClauseInTrigger.greaterThanOrEqualTo("alias", "f", 23),
                RangeClauseInTrigger.lessThanOrEqualTo("alias", "f", 23),
                RangeClauseInTrigger.range("alias", "f", 230, false, 23, false),
                RangeClauseInTrigger.greaterThan("alias", "f", 23.01)
        };

        Assert.assertEquals("length should be same", expectedJsons.length, actualObjs.length);
        for (int i=0; i<expectedJsons.length; i++) {
            assertJSONObject("failed on [+"+i+"]", expectedJsons[i], actualObjs[i].toJSONObject());
        }
    }
}
