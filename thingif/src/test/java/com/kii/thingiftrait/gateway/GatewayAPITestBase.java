...
public class GatewayAPITestBase extends SmallTestBase {
    ...
    protected GatewayAPI createGatewayAPIWithLoggedIn() throws Exception {
        ...
        GatewayAPI api = new GatewayAPI(context, app, gatewayAddress);
    ...
    protected void clearSharedPreferences() throws Exception {
        SharedPreferences sharedPreferences = RuntimeEnvironment.application.getApplicationContext()
                .getSharedPreferences("com.kii.thingif.preferences", Context.MODE_PRIVATE);
