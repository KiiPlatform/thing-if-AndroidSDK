...
public class GsonSerializationTest extends SmallTestBase {
    ...
    public void iotCloudAPITest() throws Exception {
        ...
        Target target = new StandaloneThing("th.1234567890", "thing-access-token-1234");
        ...
        JsonObject expectedJson = (JsonObject) new JsonParser().parse(
                "{" +
                        ...
                        "    \"target\":{\"typedID\":\"thing:th.1234567890\",\"class\":\"com.kii.thingif.StandaloneThing\",\"accessToken\":\"thing-access-token-1234\"}," +
                        "    \"schemas\":[" +
                        "        {" +
